...
$db['read']['username'] = 'chess_r';
$db['read']['password'] = getenv('CHESS_READ_PASSWORD');
$db['read']['database'] = 'chess';
...
$db['write']['username'] = 'chess_w';
$db['write']['password'] = getenv('CHESS_WRITE_PASSWORD');
$db['write']['database'] = 'chess';
